...
class TbdetailspiderSpider(scrapy.Spider):
    ...
    def parse_tb(self, response):
        ...
        yield scrapy.Request(tmall_descurl,
                             ...
                             meta={
                                 ...
                                 'prod_name': prod_name, 'skuBase': skuBase},
                             dont_filter=True)
    ...
    def parse_detail(self, response):
        ...
        descurl = 'https://h5api.m.taobao.com/h5/mtop.taobao.detail.getdesc/6.0/?jsv=2.4.11&data={"id":"%s","type":"1"}' % slug

        yield scrapy.Request(descurl,
    ...
    def parse_img_new(self, response):
        ...
        sel = scrapy.selector.Selector(text=text)
        image_urls = sel.css('img::attr(src)').getall()
        if not image_urls:
